...
const readRefTable = (pdfBuffer, position) => {
    ...
    if (refTable.indexOf('xref') !== 0) {
        console.log('readRefTable.js:9 => Formato de tabela de referência cruzada inesperado.')
        //throw new SignPdfError( 'Unexpected cross-reference table format.', SignPdfError.TYPE_PARSE );
    }
